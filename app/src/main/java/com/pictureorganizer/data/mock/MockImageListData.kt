...
object MockImageListData {
    ...
    private val placeholderColors = listOf(
        ...
        0xFFBA68C8, 0xFF4DD0E1, 0xFFAED581, 0xFFFF8A65,
        0xFF7986CB, 0xFF4DB6AC, 0xFFF06292, 0xFF9575CD
    )

    fun pendingItems(): List<ImageListItem> = listOf(
    ...
    fun confirmedItems(): List<ImageListItem> = listOf(
    ...
    fun noModifyItems(): List<ImageListItem> = listOf(
