...
sealed interface MainUiEvent {
    data class SelectTab(val tab: MainTab) : MainUiEvent
    data object ToggleEditMode : MainUiEvent
    data object SelectAll : MainUiEvent
    data class ToggleSelect(val id: String) : MainUiEvent
    data class MoveSelectedTo(val status: ImageStatus) : MainUiEvent
